...
Ext.define('Tutorial.store.Centers', {
    ...
    proxy: {
        ...
        api: {
            ...
            create: 'http://localhost:8080/api/centers',

            // GET - Leer todos los centros
            read: 'http://localhost:8080/api/centers/search',

            // PUT - Actualizar centro existente
            update: 'http://localhost:8080/api/centers',

            // DELETE - Eliminar centro
            destroy: 'http://localhost:8080/api/centers'
        },
