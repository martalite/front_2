...
Ext.define('Tutorial.store.Patients', {
    ...
    proxy: {
        ...
        api: {
            ...
            create: 'http://localhost:8080/api/patients',

            // GET - Leer todos los centros
            read: 'http://localhost:8080/api/patients/search',

            // PUT - Actualizar centro existente
            update: 'http://localhost:8080/api/patients',

            // DELETE - Eliminar centro
            destroy: 'http://localhost:8080/api/patients'
        },
    ...
    listeners: {
        ...
        load: function (store, records, successful) {
            if (successful) {
                console.log('✅ Datos cargados correctamente:', records.length, 'pacientes');
            } else {
